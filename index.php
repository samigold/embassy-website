        ...
        <div class="row row-y-center about-content">
            ...
            <div class="column large-half medium-full">
                <ul class="about-sched">
                    <li>
                        <h4>Boiling Point Revival Service</h4>
                        <p>
                        Sunday - 4:00 PM <br>
                        Cenon Pavilion 181 Bakori Road, PW, Opp Allington Hotel, Kubwa, Abuja.
                        </p>
                    </li>
                    <li>
                        <h4>12hours Prayer Meeting</h4>
                        <p>
                        Friday - 8:00 PM <br>
                        Cenon Pavilion 181 Bakori Road, PW, Opp Allington Hotel, Kubwa, Abuja.
                        </p>
    ...
    <section class="s-connect">
        ...
        <div class="row connect-content">
            <div class="column large-half tab-full">
                <h3 class="display-1">Partner With Us.</h3>
                <p>
        ...
        <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="text-center py-8" id="cta-2">
        ...
        <div class="row block-large-1-2 block-900-full events-list">
            ...
            <div class="column events-list__item">
                <h3 class="display-1 events-list__item-title">
                    <a href="#0" title="">Experiencing Boiling Point Revival Service.</a>
                </h3>
                <p>
                ...
                <ul class="events-list__meta">
                    <li class="events-list__meta-date">Sunday, July 28, 2024</li>
                    <li class="events-list__meta-time">4:00PM</li>
        ...
        <div class="row row-y-center series-content">
            ...
            <div class="column large-half medium-full">
                <div class="series-content__buttons">
                    <a href="" class="btn btn--large h-full-width">Watch our Videos</a>
                    <a href="" class="btn btn--large h-full-width">Listen To Messages</a>
                </div>

                <div class="series-content__subscribe">
                    <p>
                    Never miss a message. Subscribe to our YouTube and Podcast channels.
                    </p>
